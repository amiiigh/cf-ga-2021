...
function getLinksArray() {
    const links = [{
            "name": "A sample URL",
            "url": "https://asampleurl.com"
        },
        {
            "name": "Another sample URL",
            "url": "https://anothersampleurl.com"
        },
        {
            "name": "A final sample URL",
            "url": "https://afinalsampleurl.com"
        }
    ]
    return links
}
...
function getSocialLinksArray() {
    const links = [{
            ...
            "url": "https://www.instagram.com/amiiigh"
        },
        {
            "svg": "https://simpleicons.org/icons/linkedin.svg",
            "url": "https://www.linkedin.com/in/amiiigh/"
        },
        {
            "svg": "https://simpleicons.org/icons/github.svg",
            "url": "https://github.com/amiiigh"
        },
        {
            "svg": "https://simpleicons.org/icons/twitter.svg",
            "url": "https://twitter.com/amiiigh"
        }
    ]
    return links
}
    ...
    async element(element) {
        for (let link of this.links) {
            ...
            await fetch(link.svg).then(r => r.text()).then((r) => {
                element.append('<a href="' + link.url + '">' + r.slice(0, 4) + ' style="width: inherit; height:inherit; "' + r.slice(4) + '</a>', {
                    html: true
                })
            })
